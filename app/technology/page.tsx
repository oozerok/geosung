...
export default function TechnologyEquipmentPage() {
  ...
  const equipmentList = [
    { name: "SKT100", spec: "6인치", maker: "현대", count: 2, date: "2010.07" },
    { name: "SE2200L", spec: "8인치", maker: "현대", count: 2, date: "2025.09" },
    { name: "SKT200", spec: "8인치", maker: "현대", count: 2, date: "2011.11" },
    { name: "SE2200A", spec: "6인치", maker: "현대", count: 2, date: "2025.09" },
    { name: "SE2600", spec: "10인치", maker: "현대", count: 2, date: "2025.10" },
    { name: "SE2200L", spec: "8인치", maker: "현대", count: 4, date: "2025.10" },
    ...
    { name: "VX400", spec: "4호기", maker: "현대", count: 1, date: "2008.07" },
    { name: "VX400", spec: "4호기", maker: "현대", count: 1, date: "2010.09" },
    { name: "Mynx6500/50", spec: "머시닝센터 6.5호기", maker: "두산", count: 1, date: "2012.07" },
    { name: "F500", spec: "머시닝센터 5호기", maker: "현대", count: 1, date: "2012.09" },
